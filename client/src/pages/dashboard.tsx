...
import { Play, Bluetooth, Radio, Antenna, Wifi, CircuitBoard, Satellite, Thermometer, Radar, Loader2, RefreshCw, Square, Signal } from "lucide-react";
...
export default function Dashboard() {
  ...
  const startMonitoring = useCallback(() => {
    ...
    toast({
      ...
      description: "Scanning all bands for wireless signals.",
    });
        ...
        {!selectedDevice && (
          <Card className="flex flex-col overflow-visible gap-3 p-4 relative z-10">
              ...
              <>
                <div className="flex flex-col items-center justify-center py-4 gap-2">
                  ...
                  <p className="text-[10px] text-muted-foreground text-center max-w-[260px]">
                    Start monitoring to passively scan all wireless bands and discover nearby signals and devices.
                  </p>
            ...
            {monitoring && (
              ...
              >
                <Square className="w-3.5 h-3.5 mr-1.5" />
                Stop Monitoring ({totalIntercepted} signals)
              </Button>
            )}
          </Card>
        )}
