...
- **Simplified Dashboard:** Removed complex hardware collector API key management, Python script downloads, and hardware/phone mode toggles. Dashboard now provides streamlined monitoring with one-click start/stop.
- **Simplified Settings:** Removed collector API key management and script download sections. Settings focuses on data mode and user preferences.
